...
pkg_dir = roslib.packages.get_pkg_dir('mechknownet_autolabel')
mrcnn_dir = os.path.join(pkg_dir,"scripts/mask_rcnn")
...
class mask_rcnn_server:
    ...
    def __init__(self):
        ...
        self.mrcnnSrv = rospy.Service("mechknownet_label_mrcnn", mrcnn, self.srvCb)
